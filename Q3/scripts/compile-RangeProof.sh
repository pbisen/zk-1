...
node ./RangeProof/RangeProof_js/generate_witness.js ./RangeProof/RangeProof_js/RangeProof.wasm ./input.json ./RangeProof/witness.wtns 


snarkjs groth16 setup RangeProof/RangeProof.r1cs powersOfTau28_hez_final_10.ptau RangeProof/circuit_0000.zkey
snarkjs g16p RangeProof/circuit_0000.zkey RangeProof/witness.wtns RangeProof/proof.json RangeProof/public.json
